<template>
  <div
    class="w-full h-screen fixed top-0 left-0 bg-teal-400 z-[40] flex flex-col justify-center items-center"
  >
    <svg
    ...
    <div class="text-white">Please wait while we sign in your account</div>
  </div>
</template>

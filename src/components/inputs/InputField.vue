...
<template>
  <div class="group">
    ...
    <input
      ...
      >
      <div v-if="hasError" class="text-sm text-red-600 flex flex-row gap-1 items-center justify-start">
        <svg class="fill-red-600" width="12px" height="12px" viewBox="0 -0.5 24 24"
          id="meteor-icon-kit__solid-exclamation-triangle" fill="none" xmlns="http://www.w3.org/2000/svg">
